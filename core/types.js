...
const LAYER_TEXTURE_VALUE     = 'LTXT#';
const LAYER_TEXTURE           = 'LTXT';
const LAYER_TEXTURE_TYPES     = [LAYER_TEXTURE_VALUE, LAYER_TEXTURE];

const LAYER_GLASS_VALUE       = 'LGLS#';
const LAYER_GLASS             = 'LGLS';
const LAYER_GLASS_TYPES       = [LAYER_GLASS_VALUE, LAYER_GLASS];

const LAYER_NOISE_MONO_VALUE  = 'LNSMONO#';
const LAYER_NOISE_MONO        = 'LNSMONO';
const LAYER_NOISE_MONO_TYPES  = [LAYER_NOISE_MONO_VALUE, LAYER_NOISE_MONO];

const LAYER_NOISE_DUO_VALUE   = 'LNSDUO#';
const LAYER_NOISE_DUO         = 'LNSDUO';
const LAYER_NOISE_DUO_TYPES   = [LAYER_NOISE_DUO_VALUE, LAYER_NOISE_DUO];

const LAYER_NOISE_MULTI_VALUE = 'LNSMULTI#';
const LAYER_NOISE_MULTI       = 'LNSMULTI';
const LAYER_NOISE_MULTI_TYPES = [LAYER_NOISE_MULTI_VALUE, LAYER_NOISE_MULTI];
...
[
    ...
    ...LAYER_TEXTURE_TYPES,
    ...LAYER_GLASS_TYPES,
    ...LAYER_NOISE_MONO_TYPES,
    ...LAYER_NOISE_DUO_TYPES,
    ...LAYER_NOISE_MULTI_TYPES,
    ...LAYER_BLEND_TYPES,
    ...LAYER_MASK_TYPES
];
...
[
        ...
        LAYER_TEXTURE_VALUE,
          LAYER_GLASS_VALUE,
     LAYER_NOISE_MONO_VALUE,
      LAYER_NOISE_DUO_VALUE,
    LAYER_NOISE_MULTI_VALUE,
          LAYER_BLEND_VALUE,
           LAYER_MASK_VALUE
];
