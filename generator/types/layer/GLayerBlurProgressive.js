class GLayerBlurProgressive
extends GOperator1
{
    static { GNode.types[LAYER_PRBLUR] = this; }
    ...
    {
        super(LAYER_PRBLUR, nodeId, options);
    }
    ...
    async eval(parse)
    {
        ...
        const input       = await evalLayerBlurProgressiveValue(this.input,       parse);
        ...
        if (input)
        {
            this.value = new LayerBlurProgressiveValue(
                startX      ?? input.startX,
                startY      ?? input.startY,
    ...
    static parseRequest(parse)
    {
        ...
        const blur = new GLayerBlurProgressive(nodeId, options);
