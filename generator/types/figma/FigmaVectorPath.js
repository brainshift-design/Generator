...
function getPathDataFromPoints(points, closed, degree)
{
    ...
    case 3: pathData = getSmoothPathData   (points, closed);                  break;
    case 4: pathData = getSinePathData     (points, closed, getSineXSegment); break;
    case 5: pathData = getSinePathData     (points, closed, getSineYSegment); break;
    }
...
function getSmoothPathData(points, closed)
{
    if (points.length < 2)
        return '';
...
function getSinePathData(points, closed, getSineSegment)
{
    if (points.length < 2)
        return '';
