class GCompoundParam
extends GOperator
{
    static { GNode.types[COMPOUND_PARAM] = this; }
    ...
    {
        super(COMPOUND_PARAM, nodeId, options);
    }
    ...
    copy()
    {
        const copy = new GCompoundParam(this.nodeId, this.options);
    ...
    static parseRequest(parse)
    {
        ...
        const param = new GCompoundParam(nodeId, options);
