...
function displayValue(type, value)
{
    ...
    switch (type)
    {
        ...
        case     LAYER_NOISE_MONO_VALUE: return LayerNoiseMonoValue      .parse(value)[0].toDisplayString();
        case      LAYER_NOISE_DUO_VALUE: return LayerNoiseDuoValue       .parse(value)[0].toDisplayString();
        case    LAYER_NOISE_MULTI_VALUE: return LayerNoiseMultiValue     .parse(value)[0].toDisplayString();
...
function nanFromType(type)
{
    switch (type)
    {
        ...
        case     LAYER_NOISE_MONO_VALUE: return       LayerNoiseMonoValue.NaN();
        case      LAYER_NOISE_DUO_VALUE: return        LayerNoiseDuoValue.NaN();
        case    LAYER_NOISE_MULTI_VALUE: return      LayerNoiseMultiValue.NaN();
