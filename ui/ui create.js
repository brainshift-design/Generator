function createNode(nodeType, creatingButton = null, createdNodeId = -1, options = {})
{
    ...
    switch (nodeType)
    {
        ...
        case ADVANCE:                 node = new OpAdvance();            break;
        ...
        case ITEM_COUNT:              node = new OpItemCount();          break;
        ...
        case LIST_CONTAINS:           node = new OpListContains();       break;
        case LIST_FIND:               node = new OpListFind();           break;
        ...
        case BOUNDED_NUMBER:          node = new OpBoundedNumber();      break;
        ...
        case NUMBER_QUANTIZE:         node = new OpQuantize();           break;
     ...
     // case RECTANGLE_EXT:           node = new OpRectangleExt();       break;
        ...
        case SHOW_CENTER:             node = new OpShowCenter();         break;
        ...
        case REORIENT_PATHS:          node = new OpReorientPaths();      break;
        case MEASURE_VECTOR:          node = new OpMeasureVector();      break;
        case POINT_ANGLE:             node = new OpPointAngle();         break;
