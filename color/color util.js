...
function getColorName(rgb)
{
    ...
    if (sat >= 0.12)
    {
        ...
        else if (hue < 233 && hue >= 221) strHue = 'cobalt';
        else if (hue < 221 && hue >= 201) strHue = 'sky';
        else if (hue < 201 && hue >= 185) strHue = 'aqua';
        ...
        else if (hue <  63 && hue >=  45) strHue = 'yellow';
        else if (hue <  45 && hue >=  40) strHue = 'mango';
        else if (hue <  40 && hue >=  21) strHue = 'orange';
        else if (hue <  21 && hue >=  13) strHue = 'amber';
        else if (hue <  13 && hue >=   8) strHue = 'salmon';
        else if (hue <   8 || hue >= 352) strHue = 'red';
        else if (hue < 352 && hue >= 343) strHue = 'crimson';
        else if (hue < 343 && hue >= 328) strHue = 'rose';
