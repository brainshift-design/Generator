...
function initGeneratorMenus()
{
    ...
    menuShapes.addItems([
        ...
        new MenuItem('Text',      {icon: iconTextShape,  createType: TEXT_SHAPE, callback: e => actionManager.do(getCreateNodeAction(TEXT_SHAPE, btnShape.div, getCreateOptions(e)))})]);
    ...
    menuShape.addItems([
        ...
        menuItemShapeSep1     = new MenuItem('',            {separator: true}),
                                ...
                                new MenuItem('',            {separator: true}),
                                new MenuItem('Apply style', {icon: iconApply, createType: SHAPE_APPLY, callback: e => actionManager.do(getCreateNodeAction(SHAPE_APPLY, btnShape.div, getCreateOptions(e)))}),
                                new MenuItem('',            {separator: true}),
