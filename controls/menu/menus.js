...
function initGeneratorMenus()
{
    ...
    menuData.addItems([
        ...
        menuItemIfElse = new MenuItem('I&hairsp;f / else', {icon: iconIfElse,      createType: IF_ELSE,      callback: e => actionManager.do(getCreateNodeAction(IF_ELSE,       btnData.div, getCreateOptions(e))), disambiguate: true}),
                         new MenuItem('List contains',     {icon: iconContains,    createType: CONTAINS,     callback: e => actionManager.do(getCreateNodeAction(CONTAINS,      btnData.div, getCreateOptions(e))), disambiguate: true}),
                         new MenuItem('',                  {separator: true}),     
    ...
    menuString.addItems([
        ...
        new MenuItem('Text contains',       {icon: iconTextContains,  createType: TEXT_CONTAINS,  callback: e => actionManager.do(getCreateNodeAction(TEXT_CONTAINS,  btnText.div, getCreateOptions(e)))}),
        new MenuItem('',                    {separator: true}),
