...
function initGeneratorMenus()
{
    ...
    menuVectorPath.addItems([
        ...
        menuItemVectorNetwork      = new MenuItem('Network',   null,          false, {icon: iconVectorNetwork,               createType: VECTOR_NETWORK, callback: e => actionManager.do(getCreateNodeAction(VECTOR_NETWORK, btnShape.div, getCreateOptions(e)))}),
                                     ...
                                     new MenuItem('',          null,          false, {separator: true}),           
                                     new MenuItem('Functions', null,          false, {childMenu: menuVectorFunctions})]);
    ...
    menuShape.addItems([
        // menuItemShapeSelected = new MenuItem('Selected objects...', null, {icon: iconSelected,   enabled: false}),
                             // new MenuItem('',            null, false, {separator: true}),
                                ...
                                new MenuItem('Vector',      null, false, {icon: iconVectorPath,    childMenu: menuVectorPath}),
                                new MenuItem('',            null, false, {separator: true}),
        ...
        menuItemShapeSep1     = new MenuItem('',            null, false, {separator: true}),
                                ...
                                new MenuItem('Styles',      null, false, {icon: iconStyle, childMenu: menuStyles}),
                                new MenuItem('',            null, false, {separator: true}),
        menuItemShapeRender   = new MenuItem('Render',      null, false, {icon: iconRenderDown, createType: RENDER, callback: e => actionManager.do(getCreateNodeAction(RENDER, btnShape.div, getCreateOptions(e)))})]);
     //                         new MenuItem('',            null, false, {separator: true}),
    ...
    menuGraph.addItems([
        ...
        menuItemGraphPasteConnected = new MenuItem('Paste connected',      null, false, {shortcut: osCtrlShift() + 'V', callback: e => { hideAllMenus(); graphView.pasteCopiedNodes(true,  e.clientX, e.clientY - getTopHeight()); }}),
                                      new MenuItem('',                     null, false, {separator: true}),
        menuItemGraphDeactivateAll  = new MenuItem('Deactivate all nodes', null, false, {callback: () => actionManager.do(new MakeActiveNodesAction([], false))}),
                                      new MenuItem('',                     null, false, {separator: true}),
    ...
    menuNode.addItems([
        ...
        menuItemNodeActivate        = new MenuItem('Activate',         null, false, {shortcut:  osAlt()     + 'A',  callback: () => makeSelectedNodesActive()}),
        menuItemNodeDeactivate      = new MenuItem('Deactivate',       null, false, {shortcut:  osAlt()     + 'D',  callback: () => makeSelectedNodesInactive()}),
