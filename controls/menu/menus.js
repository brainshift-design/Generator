...
function initGeneratorMenus()
{
    ...
    menuData.addItems([
        ...
        menuItemList        = new MenuItem('Expand list. . .',  'Expand list',   false, {icon: iconExpand,          createType: LIST,          callback: e => actionManager.do(getCreateNodeAction(LIST,             btnData.div, getCreateOptions(e)))}),
                              new MenuItem('',                  null,            false, {separator: true}),     
    ...
    menuColor.addItems([
        ...
        menuItemValidColor   = new MenuItem('Valid sRGB',    null,                false, {childMenu: menuValidColor, icon: iconValidColor,       callback: e => actionManager.do(getCreateNodeAction(VALID_COLOR,       btnColor.div, getCreateOptions(e)))}),
                               ...
                               new MenuItem('Delta E',       null,                false, {icon: iconColorDeltaE,      callback: e => actionManager.do(getCreateNodeAction(COLOR_DELTA_E,     btnColor.div, getCreateOptions(e)))}),
