...
var menuItemNodeShowValueNames;
...
function initGeneratorMenus()
{
    ...
    menuData.addItems([
        ...
        //                new MenuItem('Select from list', null,            false, {icon: iconSelectFromList,            createType: SELECT_FROM_LIST, callback: e => actionManager.do(getCreateNodeAction(SELECT_FROM_LIST, btnData.div, getCreateOptions(e)))}),
                          new MenuItem('',                 null,            false, {separator: true}),     
        menuItemCount   = new MenuItem('Item count',            null,            false, {icon: iconCount,                     createType: ITEM_COUNT,       callback: e => actionManager.do(getCreateNodeAction(ITEM_COUNT,       btnData.div, getCreateOptions(e)))}),
        ...
        //new MenuItem('',                 null,            false, {separator: true}),     
                          new MenuItem('List contains',         'List contains', true,  {icon: iconListContains,              createType: LIST_CONTAINS,    callback: e => actionManager.do(getCreateNodeAction(LIST_CONTAINS,    btnData.div, getCreateOptions(e))), disambiguate: true}),
                          new MenuItem('Find in list',     'Find in list',  true,  {icon: iconListFind,                  createType: LIST_FIND,        callback: e => actionManager.do(getCreateNodeAction(LIST_FIND,        btnData.div, getCreateOptions(e))), disambiguate: true}),
                          new MenuItem('',                 null,            false, {separator: true}),     
    ...
    menuColor.addItems([
        ...
        menuItemColorDifference = new MenuItem('Difference',       null,                false, {icon: iconColorDifference,      callback: e => actionManager.do(getCreateNodeAction(COLOR_DIFFERENCE,     btnColor.div, getCreateOptions(e)))}),
                                  new MenuItem('',                 null,                false, {separator: true}),
    ...
    menuLayerBlur.addItems([
        new MenuItem('Progressive', 'Progressive layer blur',      true, {icon: iconLayerBlurProgressive, callback: e => actionManager.do(getCreateNodeAction(LAYER_PRBLUR, btnShape.div, getCreateOptions(e)))})]);

    menuBackBlur = new Menu('Background blur', true, false);
    menuBackBlur.addItems([
        new MenuItem('Progressive', 'Progressive background blur', true, {icon: iconBackBlurProgressive, callback: e => actionManager.do(getCreateNodeAction(BACK_PRBLUR, btnShape.div, getCreateOptions(e)))})]);

    menuLayerNoise = new Menu('Layer noise', true, false);
    menuLayerNoise.addItems([
        new MenuItem('Mono',  null, true, {icon: iconLayerNoise, callback: e => actionManager.do(getCreateNodeAction(LAYER_NOISE_MONO,  btnShape.div, getCreateOptions(e)))}),
        new MenuItem('Duo',   null, true, {icon: iconLayerNoise, callback: e => actionManager.do(getCreateNodeAction(LAYER_NOISE_DUO,   btnShape.div, getCreateOptions(e)))}),
        new MenuItem('Multi', null, true, {icon: iconLayerNoise, callback: e => actionManager.do(getCreateNodeAction(LAYER_NOISE_MULTI, btnShape.div, getCreateOptions(e)))})]);
    ...
    menuVectorPoints.addItems([
                                     ...
                                     new MenuItem('Average point',         null,          false, {icon: iconAveragePoint,       createType: AVERAGE_POINT,         callback: e => actionManager.do(getCreateNodeAction(AVERAGE_POINT,         btnShape.div, getCreateOptions(e)))}),
        ...
        menuItemPointAlongPath     = new MenuItem('Point along path',      null,          false, {icon: iconPointAlongPath,     createType: POINT_ALONG_PATH,      callback: e => actionManager.do(getCreateNodeAction(POINT_ALONG_PATH,      btnShape.div, getCreateOptions(e)))}),
                                     new MenuItem('',                      null,          false, {separator: true}),       
                                     new MenuItem('Reorient points',       null,          false, {icon: iconReorientPoints,     createType: REORIENT_POINTS,       callback: e => actionManager.do(getCreateNodeAction(REORIENT_POINTS,       btnShape.div, getCreateOptions(e)))}),
                                     new MenuItem('',                      null,          false, {separator: true}),       
    ...
    menuTransform.addItems([
        ...
        menuItemPerspective = new MenuItem('Perspective', null, false, {icon: iconPerspective, createType: PERSPECTIVE, callback: e => actionManager.do(getCreateNodeAction(PERSPECTIVE, btnShape.div, getCreateOptions(e)))}),
                              new MenuItem('',            null, false, {separator: true}),
...
function initNodeMenu()
{
    const menuItems = [
      ...
      //                               new MenuItem('',                      null, false, {separator: true}),
        ...
        menuItemNodeRandomizeNodes   = new MenuItem('Randomize',             null, false, {shortcut:  osShift() + 'R           ', icon: iconProbability, callback: e => { hideAllMenus(); graphView.randomizeSelectedNodes(); }}),
        menuItemNodeShowValueNames   = new MenuItem('Show value names',      null, false, {shortcut:  osShift() + 'N', callback: e => { hideAllMenus(); graphView.toggleShowValueNames(); }}),
    ...
    const canShowValueNames   = graphView.selectedNodes.some(n => n.type == ITEMS);
    const anyShowValueNames   = graphView.selectedNodes.some(n => n.type == ITEMS && n.showValueNames);


    menuItemNodeShowValueNames.setIcon(anyShowValueNames ? iconCheck : NULL);
    ...
    updateElementDisplay(menuItemNodeSepRnd          .div, canConnectSeeds || canRandomizeSeeds || canRandomizeColors || canRandomizeNumbers || canShowValueNames);
    ...
    updateElementDisplay(menuItemNodeShowValueNames  .div, canShowValueNames);
    ...
    menuNode = new Menu(
        'Node menu', 
        canConnectSeeds || canRandomizeSeeds || canRandomizeColors || canRandomizeNumbers || canShowValueNames, 
        false);

    menuNode.showChecks = isCondition;
    menuNode.addItems(menuItems);
}
