...
extends NumberParamBase
{
                ...
                dragScale    = 0.05)
    {
        ...
        if (hasInput)  this.initInput(NUMBER_TYPES, null, this.input_getBackInitValue);
        if (hasOutput) this.initOutput([NUMBER_VALUE], this.output_genRequest, null, this.output_backInit);
