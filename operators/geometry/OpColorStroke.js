...
extends OpGeometryBase
{
    ...
    constructor()
    {
        ...
        this.addParam(this.paramStrokeFit    = new SelectParam('strokeFit',    '',        false, true, true, ['Inside', 'Center', 'Outside'], 0));
        this.addParam(this.paramStrokeJoin   = new SelectParam('strokeJoin',   '',        false, true, true, ['Miter', 'Bevel', 'Round'], 0));
