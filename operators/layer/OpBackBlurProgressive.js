class OpBackBlurProgressive
extends OperatorBase
{
    static { Operator.types[BACK_PRBLUR] = this; }
    ...
    constructor()
    {
        super(BACK_PRBLUR, 'backBlur', 'background blur', iconBackBlurProgressive);

        this.canDisable = true;
        

        this.addInput (new Input([BACK_PRBLUR_VALUE], getNodeInputValuesForUndo, this.input_getBackInitValue));
        this.addOutput(new Output([BACK_PRBLUR_VALUE], this.output_genRequest, getNodeOutputValuesForUndo, this.output_backInit));
    ...
    output_backInit(value)
    {
        ...
        consoleAssert(value.type == BACK_PRBLUR_VALUE, 'expected BACK_PRBLUR_VALUE in backInit()');
