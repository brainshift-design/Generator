class OpLayerNoiseMulti
extends OperatorBase
{
    static { Operator.types[LAYER_NOISE_MULTI] = this; }
    ...
    constructor()
    {
        super(LAYER_NOISE_MULTI, 'layerNoiseMulti', 'multi noise', iconLayerNoise);

        this.canDisable  = true;
        this.iconOffsetY = 1;
        

        this.addInput (new Input([LAYER_NOISE_MULTI_VALUE], getNodeInputValuesForUndo, this.input_getBackInitValue));
        this.addOutput(new Output([LAYER_NOISE_MULTI_VALUE], this.output_genRequest, getNodeOutputValuesForUndo, this.output_backInit));
        ...
        this.addParam(this.paramOpacity = new NumberParam('opacity', 'opacity', false, true, true, 25, 0, 100));
    ...
    output_backInit(value)
    {
        ...
        consoleAssert(value.type == LAYER_NOISE_MULTI_VALUE, 'expected LAYER_NOISE_MULTI_VALUE in backInit()');
