class Connection
{
    ...
    updateWire()
    {
        ...
        this.wire.outBall.style.visibility = 'visible';
        this.wire.outBall.setAttribute('cx', x1);
        this.wire.outBall.setAttribute('cy', y1);

        this.wire.inBall.style.visibility = 'visible';
    ...
    updateWireFromOutput(x, y)
    {
        ...
        this.wire.inBall.style.visibility = 'hidden';
    }
    ...
    updateWireFromInput(x, y)
    {
        ...
        this.wire.outBall.style.visibility = 'hidden';
    }
}