    ...
    constructor(output, input)
    {
        ...
        this.wire.updateStyle = (color) =>
        {
                ...
                || this. input && this. input.wireColor[3] < 1)
            {
                ...
                this.wire.xp1.style.strokeDasharray  = 11 * graphView.zoom;
                ...
                this.wire.xp2.style.strokeDasharray  = 11 * graphView.zoom;
                this.wire.xp2.style.strokeDashoffset = 11 * graphView.zoom;
            }
            else
            {
