...
//         newInput.addEventListener('connect',    e => { OpBooleanBase_onConnectInput(this); e.detail.input.isNew = false; });
//         newInput.addEventListener('disconnect', e => OpBooleanBase_onDisconnectInput(this, e.detail.input));
...
// function OpBooleanBase_onConnectInput(node)
// {
//     node.addNewInput();
// }
...
// function OpBooleanBase_onDisconnectInput(node, input)
// {
