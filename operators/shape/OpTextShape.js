...
extends OpShape
{
    ...
    constructor()
    {
        ...
        this.addParam(this.paramFont          = new OptionParam('font',          'font',     false, true, true, figUniqueFontNames, interIndex));
        this.addParam(this.paramSize          = new NumberParam('size',          'size',     true,  true, true,  12, 1));
        this.addParam(this.paramStyle         = new OptionParam('style',         'style',    false, true, true, [''], 0));
        this.addParam(this.paramAlignX        = new OptionParam('alignX',        'align X',  true,  true, true, TextAlignX, 0));
        this.addParam(this.paramAlignY        = new OptionParam('alignY',        'align Y',  true,  true, true, TextAlignY, 1));
